        ...
        <div class="container-fluid">
          ...
          <div class="row">
              ...
              <div class="card shadow mb-4" style="width:100%">
                ...
                <a class="btn btn-primary pull-right" style="margin:20px 20px 0px 20px" href="<?= base_url('guru/tambahUser/');?>">
                  <i class="fa fa-plus"></i> Tambah</a>
                  <a class="btn btn-primary pull-right" style="margin:10px 20px 0px 20px" href="<?= base_url('guru/importUser/');?>">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php
                      $no = 1;
                      foreach($user as $u){
                        if($u->unit == $this->session->unit){
                    ?>
                    <tr>
                      <td><?php echo $no;?></td>
                      <td><?php echo $u->nik;?></td>
                      <td><?php echo $u->no_absen;?></td>
                      <td><?php echo $u->nama;?></td>
                      <td><?php echo $u->unit;?></td>
                      <td><?php echo $u->kelas;?></td>
                      <td><?php echo $u->role;?></td>
                      <td><?php echo $u->jenis_kelamin;?></td>
                      <td> <a class="btn btn-primary btn-xs" href="<?= base_url('guru/ubahUser/'.$u->id);?>">
                          <i class="fa fa-pencil">Edit</i></a> 
                          <a class="btn btn-danger btn-xs" href="<?= base_url('guru/hapusUser/'.$u->id);?>" onclick="return confirm('Yakin akan menghapus data ini?');">
