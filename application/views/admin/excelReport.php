...
<head>
	...
	for ($i = 0; $i < $max; $i++) {
		for ($j = 0; $j < count($nilai); $j++) {
			if ($nilai[$j]->id_ujian == $ujian->id) {
				$ct += 1;
			}
		}
		$dataNilai[$ujian->id] = $ct;
		$ct = 0;
	}
	?>
</head>
				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="card shadow mb-4" style="width:100%">
							...
							<div class="card-body">
								<form class="user" action="<?php echo base_url(); ?>admin/downloadExcelPerKelas" method="post">
									<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
										...
										<tbody>
											...
											<tr>
												...
												<td><?php echo $ujian->tipe; ?></td>
												<td><?php echo $ujian->jenis; ?></td>
												<td>
													<select name="kelas">
												...
												<td><input class="btn btn-primary pull-right" type="submit" value="Download" name="btnSubmit"></td>
											</tr>
										</tbody>
									</table>
								</form>
