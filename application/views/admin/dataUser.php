				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="card shadow mb-4" style="width:100%">
							...
							<a class="btn btn-primary pull-right" style="margin:20px 20px 0px 20px" href="<?= base_url('admin/tambahUser/'); ?>">
								<i class="fa fa-plus"></i> Tambah</a>
							<a class="btn btn-primary pull-right" style="margin:10px 20px 0px 20px" href="<?= base_url('admin/importUser/'); ?>">
									...
									<tbody>
										...
										?>
											<tr>
												...
												<td><?php if ($u->last_status == 0) {
														echo "offline";
													} else if ($u->last_status == 2) {
														echo "sedang ujian";
													} else {
														echo "online";
													} ?></td>
												<td><?php echo $u->role; ?></td>
												<td> <a class="btn btn-primary btn-xs" href="<?= base_url('admin/ubahUser/' . $u->id); ?>">
														<i class="fa fa-pencil">Edit</i></a>
													<a class="btn btn-danger btn-xs" href="<?= base_url('admin/hapusUser/' . $u->id); ?>" onclick="return confirm('Yakin akan menghapus data ini?');">
