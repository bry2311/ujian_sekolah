									...
									?>
													<div class="card-body">
														...
														<div style="white-space: pre-wrap; /* CSS3 */ white-space: -moz-pre-wrap; /* Firefox */ white-space: -pre-wrap; /* Opera <7 */ white-space: -o-pre-wrap;/* Opera 7 */word-wrap: break-word;/* IE */">
															<h2 style="font-size:12pt;"><?php echo $tempIndex + 1;?>&nbsp;<?php echo $s->checkSoal ? htmlspecialchars($s->soal) : $s->soal; ?></h2>
														</div>
																			...
																			<table style="table-layout:fixed; width:100%">
																				...
																				?>
																					<tr>
																						...
																						<td>&nbsp;<label style="font-size:12pt;"><?php echo $s->checkE ? htmlspecialchars($s->e) : $s->e; ?></label></td>
																						<td>
																				...
																				?>
																					<tr>
																						...
																						<td>&nbsp;<label style="font-size:12pt;"><?php echo $s->checkA ? htmlspecialchars($s->a) : $s->a; ?></label></td>
																						<td>
																				...
																				<tr>
																					...
																					<td>&nbsp;<label style="font-size:12pt;"><?php echo $s->checkB ? htmlspecialchars($s->b) : $s->b; ?></label></td>
																					<td>
																				...
																				<tr>
																					...
																					<td>&nbsp;<label style="font-size:12pt;"><?php echo $s->checkC ? htmlspecialchars($s->c) : $s->c; ?></label></td>
																					<td>
																				...
																				<tr>
																					...
																					<td>&nbsp;<label style="font-size:12pt;"><?php echo $s->checkD ? htmlspecialchars($s->d) : $s->d; ?></label></td>
																					<td>
