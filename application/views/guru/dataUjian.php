				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="card shadow mb-4" style="width:100%">
							...
							<a class="btn btn-primary pull-right" style="margin:20px 20px 0px 20px" href="<?= base_url('guru/tambahUjian/'); ?>">
										...
										<tbody>
											...
											?>
												<tr>
													<td><?php echo $no; ?></td>
													<td>
														<a class="btn btn-primary btn-xs" href="<?= base_url('guru/addSoalUjian/' . $u->id); ?>">
															<i class="fa fa-pencil">Add Soal</i></a>
														<a class="btn btn-primary btn-xs" href="<?= base_url('guru/detailUjian/' . $u->id); ?>">
															<i class="fa fa-pencil">Detail</i></a>
														<a class="btn btn-primary btn-xs" href="<?= base_url('guru/ubahUjian/' . $u->id); ?>">
														...
														<a class="btn btn-danger btn-xs" href="<?= base_url('guru/resetUjian/' . $u->id); ?>" onclick="return confirm('Yakin akan mereset ujian ini?');">
															<i class="fa fa-trash-o">Reset</i></a>
														<a class="btn btn-danger btn-xs" href="<?= base_url('guru/hapusUjian/' . $u->id); ?>" onclick="return confirm('Yakin akan menghapus data ini?');">
