				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="card shadow mb-4" style="width:100%">
							...
							<a class="btn btn-primary pull-right" style="margin:20px 20px 0px 20px" href="<?= base_url('guru/tambahSoalIsian/'); ?>">
								<i class="fa fa-plus"></i> Tambah Soal Isian</a>
							<a class="btn btn-primary pull-right" style="margin:10px 20px 0px 20px" href="<?= base_url('guru/importSoalIsian/'); ?>">
								...
								<div class="scrollmenu">
									<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
										...
										<tbody>
											<?php
											$no = 1;
											foreach ($soalisian as $s) {
											?>
												<tr>
													<td><?php echo $no; ?></td>
													<td> <a class="btn btn-primary btn-xs" href="<?= base_url('guru/ubahSoalIsian/' . $s->id); ?>">
															<i class="fa fa-pencil">Edit</i></a>
														<a class="btn btn-danger btn-xs" href="<?= base_url('guru/hapusSoalIsian/' . $s->id); ?>" onclick="return confirm('Yakin akan menghapus data ini?');">
