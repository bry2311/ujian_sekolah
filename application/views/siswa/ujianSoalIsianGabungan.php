      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
              ...
              <div class="card shadow mb-4" style="width:100%">
                <div class="card-header py-3">
                  <ul class="nav nav-second-level">
                    ...
                    <li>
                      <a href="<?= base_url('siswa/ujianSoalIsianGabungan/'.$tmpId."/".$tempIndex);?>">
                        <div class="card-header py-3">
                ...
                <p>
                <?php
                  for($i = 0; $i < count($this->session->soal_ujian_random2);$i++){                      
                      foreach($soal as $s){
                          if($s->id == $this->session->soal_ujian_random2[$i] && $tempIndex2 == $i){
                              $tempJawaban = -1;
                          ...
                          <div class="card-body">
                              ...
                              <br>
                              <h2><?php echo $tempIndex2+1 .". &nbsp;" .$s->soal;?></h2>
                              ...
                              <input type="text" name="jawabanSiswa" style="width:80%" placeholder="Tulis jawaban disini .." 
                              <?php
                              ...
                              <input type="hidden" name="tempIndex" value="<?php echo $tempIndex2;?>">
                              </form>
                          </div>
                          <?php
                          }                     
              ...
              <div id="visible3">
                <a class="btn btn-primary btn-xs" href="<?= base_url('siswa/back4/'.$tmpId."/".$tempIndex2);?>">
                <i class="fa fa-pencil">Back</i></a> &nbsp;
                <a class="btn btn-primary btn-xs" href="<?= base_url('siswa/next4/'.$tmpId."/".$tempIndex2);?>">
