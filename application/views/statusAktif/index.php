			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-gray-800">Data User Aktif</h1>
					</div>
					<!-- Content Row -->
					<div class="row">
						<!-- Approach -->
							...
							<div class="card-body">
								<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
									...
									<tbody>
										...
										foreach ($user as $u) {
											$namaUjian = "-";
											foreach ($ujianAktif as $ua) {
												if ($u->last_ujian != null) {
													if ($u->last_ujian == $ua->id) {
														$namaUjian = $ua->nama;
													}
												}
											}
										?>
											<tr>
												<td><?php echo $no; ?></td>
												<td> <a class="btn btn-danger btn-xs" href="<?= base_url('StatusUser/reset/' . $u->nik); ?>">
														<i class="fa fa-pencil">Reset</i></a></i></a>
												</td>
