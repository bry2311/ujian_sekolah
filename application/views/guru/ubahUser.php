        ...
        <div class="container-fluid">
          ...
          <div class="row">
              ...
              <div class="card shadow mb-4" style="width:100%">
                ...
                <div class="card-body">
                <form class="user" action="<?php echo base_url();?>guru/simbahUbahUser" method="post">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">    
                  <tr> 
                    <td>No absen </td>
                    <td><input type="text" name="no_absen" value="<?php echo $user->no_absen;?>"></td>
                  </tr>  
                  <tr> 
                    <td>NIK </td>
                    <td><input type="text" name="nik" value="<?php echo $user->nik;?>"></td>
                  </tr>
                  <tr> 
                    <td>Nama User </td>
                  ...
                  <tr> 
                    <td>Re-Password </td>
                    <td><input type="password" name="repassword" value="123"></td>
                  </tr>
                  <tr>
                    <td>Unit </td>
                    <td>
                      <select name="unit">
                        <option><?php echo $this->session->unit;?></option>
                      </select>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>                 
                      ...
                      <option value="" >--Pilih Kelas--</option>
                        ...
                        foreach($kelas as $k)
                        {
                          if($k->unit == $this->session->unit){
                          ?> 
                          <option value="<?php echo $k->nama;?>" <?php if($k->nama == $user->kelas){ echo 'selected' ;}?>><?php echo $k->nama;?></option>
                          <?php
                          }
                        }
                        ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <select name="role">
                        <option <?php if($user->role == 'Guru'){ echo 'selected';}?>>Guru</option>
                        <option <?php if($user->role == 'Siswa'){ echo 'selected';}?>>Siswa</option>
                      </select>
                    </td>
                  </tr>
                  <tr> 
                    ...
                    <td><select name="jenis_kelamin">
                          <option <?php if($user->jenis_kelamin == 'L'){ echo 'selected';}?>>L</option>
                          <option <?php if($user->jenis_kelamin == 'P'){ echo 'selected';}?>>P</option>
                        </select>
                    </td>
                  </tr>
                  <tr>
