          ...
          <div class="row">
              ...
              <div class="card shadow mb-4" style="width:100%">
                ...
                <tr> 
                      ...
                      <select name="kelas">
                        <?php if($this->session->unit == "SMP"){
                          ...
                          <?php
                            ...
                            ?>
                            <option value="1" <?php if($soal->kelas == '1'){ echo 'selected';}?>>1</option>
                            <option value="2" <?php if($soal->kelas == '2'){ echo 'selected';}?>>2</option>
                            <option value="3" <?php if($soal->kelas == '3'){ echo 'selected';}?>>3</option>
                            <option value="4" <?php if($soal->kelas == '4'){ echo 'selected';}?>>4</option>
                            <option value="5" <?php if($soal->kelas == '5'){ echo 'selected';}?>>5</option>
                            <option value="6" <?php if($soal->kelas == '6'){ echo 'selected';}?>>6</option>
                            <?php
                          }else{
                            ?>
                  ...
                  <tr> 
                    <td>Kunci 1 </td>
                    <td><input type="text" name="kunci_jawaban1" value="<?php echo $soal->kunci_jawaban1;?>"></td>
                  </tr>
                  <tr> 
                    <td>Kunci 2 </td>
                    <td><input type="text" name="kunci_jawaban2" value="<?php echo $soal->kunci_jawaban2;?>"></td>
                  </tr>
                  <tr> 
                    <td>Kunci 3 </td>
                    <td><input type="text" name="kunci_jawaban3" value="<?php echo $soal->kunci_jawaban3;?>"></td>
                  </tr>
                  <tr> 
                    <td>Kunci 4 </td>
                    <td><input type="text" name="kunci_jawaban4" value="<?php echo $soal->kunci_jawaban4;?>"></td>
                  </tr>
                  <tr> 
                    <td>Kunci 5 </td>
                    <td><input type="text" name="kunci_jawaban5" value="<?php echo $soal->kunci_jawaban5;?>"></td>
                  </tr>
                  <tr>
