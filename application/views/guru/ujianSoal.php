      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
                      ...
                      foreach($soal as $s){
                        if($s->id == $this->session->soal_ujian_random[$i] && $tempIndex == $i){
                          ...
                          <div class="card-body">
                            ...
                            <?php } ?>
                            <form class="user" action="<?php echo base_url();?>guru/addJawabanSiswa" method="post">
                              <div class="input-group">         
                              <?php
                              $tempJawaban = -1;
                              if($jawaban != null){
              ...
              <div id="visible3">
                <a class="btn btn-primary btn-xs" href="<?= base_url('guru/back/'.$tmpId."/".$tempIndex);?>">
                <i class="fa fa-pencil">Back</i></a> &nbsp;
                <a class="btn btn-primary btn-xs" href="<?= base_url('guru/next/'.$tmpId."/".$tempIndex);?>">
                <i class="fa fa-pencil">Next</i></a> &nbsp;
              </div>
              <a class="btn btn-danger btn-xs" href="<?= base_url('guru/terminate/'.$tmpId);?>" onclick="return confirm('Yakin akan mengumpulkan ujian ini?');">
