        ...
        <div class="container-fluid">
          ...
          <div class="row">
              ...
              <div class="card shadow mb-4" style="width:100%">
                ...
                <a class="btn btn-primary pull-right" style="margin:20px 20px 0px 20px" href="<?= base_url('guru/tambahKelas/');?>">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td> <a class="btn btn-primary btn-xs" href="<?= base_url('guru/ubahKelas/'.$k->id);?>">
                          <i class="fa fa-pencil">Edit</i></a> 
                          <a class="btn btn-danger btn-xs" href="<?= base_url('guru/hapusKelas/'.$k->id);?>" onclick="return confirm('Yakin akan menghapus data ini?');">
