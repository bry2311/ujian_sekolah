										...
										<tbody>
											...
											?>
												<tr>
													...
													<td><a class="btn btn-primary btn-xs" href="<?= base_url('admin/createPdf/' . $ujian->id . '/' . $n->nik . '/' . $n->kelas); ?>">
															<i class="fa fa-pencil">Download</i></a>
														<a class="btn btn-primary btn-xs" href="<?= base_url('admin/tampilNilai/' . $ujian->id . '/' . $n->id); ?>">
															<i class="fa fa-pencil">Tampil</i></a>
														<a class="btn btn-primary btn-xs" href="<?= base_url('admin/nonTampilNilai/' . $ujian->id . '/' . $n->id); ?>">
															<i class="fa fa-pencil">Sembunyi</i></a>
														<a class="btn btn-danger btn-xs" href="<?= base_url('admin/ujianUlang/' . $ujian->id . '/' . $n->id . '/' . $n->nik); ?>" onclick="return confirm('Apakah anda yakin akan menguji ulang siswa ini?');">
