			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-gray-800">Selamat datang <?= ucwords(strtolower($this->session->nama)); ?>! - <?= strtoupper($this->session->kelas); ?></h1>
					</div>
					<!-- Content Row -->
					<div class="row">
						<!-- Approach -->
							...
							<div class="card-body">
								...
								<form class="user" action="<?php echo base_url(); ?>siswa/informasiUjian" method="post">
									<table style="width:100%;">
										...
										<tr>
											<td><input type="submit" value="Submit" class="btn btn-primary " name="btnSubmit"></td>
											<td></td>
										</tr>
									</table>
								</form>
