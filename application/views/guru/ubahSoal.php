										...
										<tr>
											...
											<td>
												<select name="gambarA" id="select2">
													...
													foreach ($gambar as $g) {
													?>
														<option value="<?php echo $g->link; ?>" data-left="<?= base_url() ?>/assets/img/<?= $g->link; ?>" <?php if ($g->link == $soal->gambarA) {
																																								echo 'selected';
																																							} ?>><?php echo $g->nama; ?></option>
													<?php
													}
										...
										<tr>
											...
											<td>
												<select name="gambarB" id="select3">
													...
													foreach ($gambar as $g) {
													?>
														<option value="<?php echo $g->link; ?>" data-left="<?= base_url() ?>/assets/img/<?= $g->link; ?>" <?php if ($g->link == $soal->gambarB) {
																																								echo 'selected';
																																							} ?>><?php echo $g->nama; ?></option>
													<?php
													}
										...
										<tr>
											...
											<td>
												<select name="gambarC" id="select7">
													...
													foreach ($gambar as $g) {
													?>
														<option value="<?php echo $g->link; ?>" data-left="<?= base_url() ?>/assets/img/<?= $g->link; ?>" <?php if ($g->link == $soal->gambarC) {
																																								echo 'selected';
																																							} ?>><?php echo $g->nama; ?></option>
													<?php
													}
										...
										<tr>
											...
											<td>
												<select name="gambarD" id="select5">
													...
													foreach ($gambar as $g) {
													?>
														<option value="<?php echo $g->link; ?>" data-left="<?= base_url() ?>/assets/img/<?= $g->link; ?>" <?php if ($g->link == $soal->gambarD) {
																																								echo 'selected';
																																							} ?>><?php echo $g->nama; ?></option>
													<?php
													}
										...
										<tr>
											...
											<td>
												<select name="gambarE" id="select6">
													...
													foreach ($gambar as $g) {
													?>
														<option value="<?php echo $g->link; ?>" data-left="<?= base_url() ?>/assets/img/<?= $g->link; ?>" <?php if ($g->link == $soal->gambarE) {
																																								echo 'selected';
																																							} ?>><?php echo $g->nama; ?></option>
													<?php
													}
