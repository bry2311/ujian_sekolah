          ...
          <div class="row">
              ...
              <div class="card shadow mb-4" style="width:100%">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Tambah Soal Ke Ujian ( <?php echo count($soal_ujian);?> )</h6>
                </div>
                <div class="card-body">
                <form class="user" action="<?php echo base_url();?>guru/addSoalUjian2" method="post">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     <!--  <td> 
                          <a class="btn btn-primary btn-xs" href="<?= base_url('guru/addSoalUjianDb/'.$s->id.'/'.$ujian->id.'/'.$s->kunci_jawaban);?>">
                          <i class="fa fa-pencil">Add</i></a> 
                      </td> -->
