				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="card shadow mb-4" style="width:100%">
							...
							<div class="card-body">
								<form class="user" action="<?php echo base_url(); ?>admin/simpanUbahKelas" method="post">
									<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
										...
										<tr>
											...
											<td>
												<select name="unit">
													<option <?php if ($kelas->unit == 'TK') {
																		echo 'selected';
																	} ?>>TK</option>
													<option <?php if ($kelas->unit == 'SD') {
																		echo 'selected';
																	} ?>>SD</option>
													<option <?php if ($kelas->unit == 'SMP') {
																		echo 'selected';
																	} ?>>SMP</option>
													<option <?php if ($kelas->unit == 'SMA') {
																		echo 'selected';
																	} ?>>SMA</option>
												</select>
											</td>
