                      ...
                      <div class="card-body">
                        ...
                        <form class="user" action="<?php echo base_url();?>siswa/addJawabanSiswa3" method="post">
                          ...
                          if($jawaban != null AND $tempJawaban != -1){    
                            ...
                            ?>
                              <table>
                              <?php if(trim(strtolower($s->e)) == trim(strtolower($s->kunci_jawaban))){
                                  ?>
                                <tr>
                                <?php $ja = $s->e;?>
                                  <td><label label style="font-size:12pt;"><b>A.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="A. <?php echo $s->e;?>"
                                ...
                                <tr>
                                <?php $ja = $s->a;?>
                                  <td><label label style="font-size:12pt;"><b>A.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="A. <?php echo $s->a;?>"
                                ...
                                <tr>
                                <?php $jb = $s->b;?>
                                  <td><label label style="font-size:12pt;"><b>B.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="B. <?php echo $s->b;?>"
                                ...
                                <tr>
                                <?php $jc = $s->c;?>
                                  <td><label label style="font-size:12pt;"><b>C.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="C. <?php echo $s->c;?>"
                                ...
                                <tr>
                                <?php $jd = $s->d;?>
                                  <td><label label style="font-size:12pt;"><b>D.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="D. <?php echo $s->d;?>"
                          ...
                          <?php 
                              ...
                              <table>
                                <?php if(trim(strtolower($s->e)) == trim(strtolower($s->kunci_jawaban))){
                                  ...
                                  <?php $ja = $s->e;?>
                                  <td><label label style="font-size:12pt;"><b>A.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="A. <?php echo $s->e;?>"
                                  <?php if(trim(strtolower($jawaban[$tempJawaban]->jawaban)) == trim(strtolower($s->e))){ echo "checked";}?>></td>
                                  <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->e;?></label></td>
                                  <td>
                                  <?php if(isset($s->gambarE)){ ?>
                                    <img id="myImg2" src="<?php echo base_url();?>/assets/img/<?php echo $s->gambarE;?>" class="pic">
                                  ...
                                  <tr>
                                  <?php $ja = $s->d;?>
                                  <td><label label style="font-size:12pt;"><b>A.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="A. <?php echo $s->d;?>"
                                  <?php if(trim($jawaban[$tempJawaban]->jawaban) == trim($s->d)){ echo "checked";}?>></td>
                                  <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->d;?></label></td>
                                  <td>
                                  <?php if(isset($s->gambarD)){ ?>
                                ...
                                <tr>
                                  <?php $jb = $s->a;?>
                                  <td><label label style="font-size:12pt;"><b>B.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="B. <?php echo $s->a;?>"
                                  <?php if(trim($jawaban[$tempJawaban]->jawaban) == trim($s->a)){ echo "checked";}?>></td>                             
                                  <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->a;?></label></td>
                                  <td>
                                  <?php if(isset($s->gambarA)){ ?>
                                ...
                                <tr>
                                  <?php $jc = $s->b;?>
                                  <td><label label style="font-size:12pt;"><b>C.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="C. <?php echo $s->b;?>"
                                  <?php if(trim($jawaban[$tempJawaban]->jawaban) == trim($s->b)){ echo "checked";}?>></td>
                                  <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->b;?></label></td>
                                  <td>
                                  <?php if(isset($s->gambarB)){ ?>
                                ...
                                <tr>
                                <?php $jd = $s->c;?>
                                  <td><label label style="font-size:12pt;"><b>D.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="D. <?php echo $s->c;?>"
                                  <?php if(trim($jawaban[$tempJawaban]->jawaban) == trim($s->c)){ echo "checked";}?>></td>
                                  <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->c;?></label></td>
                                  <td>
                                  <?php if(isset($s->gambarC)){ ?>
                            ...
                            if($this->session->nik % 2 == 0){
                              ...
                              <?php if(trim(strtolower($s->e)) == trim(strtolower($s->kunci_jawaban))){
                                ...
                                <tr>
                                <?php $ja = $s->e;?>
                                  <td><label label style="font-size:12pt;"><b>A.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="A. <?php echo $s->e;?>"></td>                                  
                                  <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->e;?></label></td>
                                  <td>
                                  <?php if(isset($s->gambarE)){ ?>
                                    <img id="myImg2" src="<?php echo base_url();?>/assets/img/<?php echo $s->gambarE;?>" class="pic">
                                ...
                                <?php 
                                  ...
                                  <tr>
                                  <?php $ja = $s->a;?>
                                  <td><label label style="font-size:12pt;"><b>A.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="A. <?php echo $s->a;?>"></td>                                 
                                  <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->a;?></label></td>
                                  <td>
                                  <?php if(isset($s->gambarA)){ ?>
                                    <img id="myImg2" src="<?php echo base_url();?>/assets/img/<?php echo $s->gambarA;?>" class="pic">
                                ...
                                <tr>
                                  <?php $jb = $s->b;?>
                                  <td><label label style="font-size:12pt;"><b>B.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="B. <?php echo $s->b;?>"></td>
                                  <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->b;?></label></td>
                                  <td>
                                  <?php if(isset($s->gambarB)){ ?>
                                    <img id="myImg3" src="<?php echo base_url();?>/assets/img/<?php echo $s->gambarB;?>" class="pic">
                                ...
                                <tr>
                                <?php $jc = $s->c;?>
                                  <td><label label style="font-size:12pt;"><b>C.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="C. <?php echo $s->c;?>"></td>
                                  <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->c;?></label></td>
                                  <td>
                                  <?php if(isset($s->gambarC)){ ?>
                                ...
                                <tr>
                                <?php $jd = $s->d;?>
                                  <td><label label style="font-size:12pt;"><b>D.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="D. <?php echo $s->d;?>"></td>
                                  <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->d;?></label></td>
                                  <td>
                                  <?php if(isset($s->gambarD)){ ?>
                          ...
                          <?php 
                              ...
                              <table>
                                <?php if(trim(strtolower($s->e)) == trim(strtolower($s->kunci_jawaban))){
                                  ...
                                  <tr>
                                  <?php $ja = $s->d;?>
                                  <td><label label style="font-size:12pt;"><b>A.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="A. <?php echo $s->d;?>"></td>
                                  <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->d;?></label></td>
                                  <td>
                                  <?php if(isset($s->gambarD)){ ?>
                                    <img id="myImg2" src="<?php echo base_url();?>/assets/img/<?php echo $s->gambarD;?>" class="pic">
                                ...
                                <tr>
                                <?php $jb = $s->a;?>
                                  <td><label label style="font-size:12pt;"><b>B.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="B. <?php echo $s->a;?>"></td>                                
                                  <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->a;?></label></td>
                                  <td>
                                  <?php if(isset($s->gambarA)){ ?>
                                    <img id="myImg3" src="<?php echo base_url();?>/assets/img/<?php echo $s->gambarA;?>" class="pic">
                                ...
                                <tr>
                                <?php $jc = $s->b;?>
                                  <td><label label style="font-size:12pt;"><b>C.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="C. <?php echo $s->b;?>"></td>
                                  <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->b;?></label></td>
                                  <td>
                                  <?php if(isset($s->gambarB)){ ?>
                                    <img id="myImg4" src="<?php echo base_url();?>/assets/img/<?php echo $s->gambarB;?>" class="pic">
                                ...
                                <tr>
                                <?php $jd = $s->c;?>
                                  <td><label label style="font-size:12pt;"><b>D.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value="D. <?php echo $s->c;?>"></td>
                                  <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->c;?></label></td>
                                  <td>
                                  <?php if(isset($s->gambarC)){ ?>
                                    <img id="myImg5" src="<?php echo base_url();?>/assets/img/<?php echo $s->gambarC;?>" class="pic">
