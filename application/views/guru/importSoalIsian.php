      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Import Soal Isian</h1>
          </div>
          <!-- Content Row --> 
          <div class="row">
              <!-- Approach -->
              <div class="card shadow mb-4" style="width:100%">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Import Soal Isian</h6>
                </div> 
                <div class="card-body">
                  <h4 class="mb"> Import Excel Data Soal</h4>
                  	  <a href="<?php echo base_url("excel/formatSoalIsian.xls"); ?>">Download Format</a>
                      <form class="form-horizontal style-form" action="<?= base_url();?>guru/importSoalIsianDb" method="post" enctype="multipart/form-data">                       
                          <div class="form-group">
                            ...
                            <div class="row mt">
                              ...
                              <a href="<?= base_url('guru/dataSoalIsian');?>" class="btn btn-default">Kembali</a>
