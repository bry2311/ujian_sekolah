      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Ubah Ujian</h1>
          </div>
          <!-- Content Row -->
          <div class="row">
              <!-- Approach -->
              <div class="card shadow mb-4" style="width:100%">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Ubah Ujian</h6>
                </div>
                <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tr> 
                    ...
                    <td>
                      <select name="jenis">
                        <option <?php if($ujian->jenis == "Pilihan Ganda"){ echo "selected";}?>>Pilihan Ganda</option>
                        <option <?php if($ujian->jenis == "Isian"){ echo "selected";}?>>Isian</option>
                      </select>                     
                    </td>
                  </tr>
                  <tr> 
