...
<head>
  ...
  <style>
		#select1,
		#select1_ajax,#select2,#select3,#select7,#select5,#select6 {
			width: 350px;
			padding: 7px 10px;
		}
  </style>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
              ...
              <div class="card shadow mb-4" style="width:100%">
                ...
                <div class="card-body">
                <form class="user" action="<?php echo base_url();?>guru/simpanUbahSoal" method="post">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <td>
                      <select name="kelas">
                        <?php if($this->session->unit == "SMP"){
                          ?>
                            <option value="7" <?php if($soal->kelas == '7'){ echo 'selected';}?>>7</option>
                            <option value="8" <?php if($soal->kelas == '8'){ echo 'selected';}?>>8</option>
                            <option value="9" <?php if($soal->kelas == '9'){ echo 'selected';}?>>9</option>
                          <?php
                          }else if($this->session->unit == "SMA"){
                          ?>
                            <option value="10" <?php if($soal->kelas == '10'){ echo 'selected';}?>>10</option>
                            <option value="11" <?php if($soal->kelas == '11'){ echo 'selected';}?>>11</option>
                            <option value="12" <?php if($soal->kelas == '12'){ echo 'selected';}?>>12</option>
                          <?php
                  ...
                  <tr>
                    ...
                    <?php
                      foreach ($gambar as $g){
                        ?>
                        <option value="<?php echo $g->link;?>" data-left="<?=base_url()?>/assets/img/<?= $g->link;?>" <?php if($g->link == $soal->gambarSoal){ echo 'selected';}?>><?php echo $g->nama;?></option>
                        <?php
                      }
                    ?>                    
                    </select>
                  ...
                  <tr>
                    ...
                    <?php
                      foreach ($gambar as $g){
                        ?>
                        <option value="<?php echo $g->link;?>" data-left="<?=base_url()?>/assets/img/<?= $g->link;?>" <?php if($g->link == $soal->gambarA){ echo 'selected';}?>><?php echo $g->nama;?></option>
                        <?php
                      }
                    ?>                    
                    </select>
                  ...
                  <tr>
                    ...
                    <?php
                      foreach ($gambar as $g){
                        ?>
                        <option value="<?php echo $g->link;?>" data-left="<?=base_url()?>/assets/img/<?= $g->link;?>" <?php if($g->link == $soal->gambarB){ echo 'selected';}?>><?php echo $g->nama;?></option>
                        <?php
                      }
                    ?>                    
                    </select>
                  ...
                  <tr>
                    <td>Gambar C</td>
                    <td>
                    <select name="gambarC" id="select7">
                    <option value="">--Tidak ada Gambar--</option>                    
                    <?php
                      foreach ($gambar as $g){
                        ?>
                        <option value="<?php echo $g->link;?>" data-left="<?=base_url()?>/assets/img/<?= $g->link;?>" <?php if($g->link == $soal->gambarC){ echo 'selected';}?>><?php echo $g->nama;?></option>
                        <?php
                      }
                    ?>                    
                    </select>
                    <input value="activate" id="activate_selectator7" type="button">
                    <td>
                  </tr>
                  <script type="text/javascript">
                    $(function () {
                      var $activate_selectator = $('#activate_selectator7');
                      $activate_selectator.click(function () {
                        var $select = $('#select7');
                        if ($select.data('selectator') === undefined) {
                          $select.selectator({
                  ...
                  <tr>
                    ...
                    <?php
                      foreach ($gambar as $g){
                        ?>
                        <option value="<?php echo $g->link;?>" data-left="<?=base_url()?>/assets/img/<?= $g->link;?>" <?php if($g->link == $soal->gambarD){ echo 'selected';}?>><?php echo $g->nama;?></option>
                        <?php
                      }
                    ?>                    
                    </select>
                  ...
                  <tr>
                    ...
                    <?php
                      foreach ($gambar as $g){
                        ?>
                        <option value="<?php echo $g->link;?>" data-left="<?=base_url()?>/assets/img/<?= $g->link;?>" <?php if($g->link == $soal->gambarE){ echo 'selected';}?>><?php echo $g->nama;?></option>
                        <?php
                      }
                    ?>                    
                    </select>
                  ...
                  <tr> 
                    <td>Kunci </td>
                    <td><textarea name="kunci_jawaban" style="width:500px"><?php echo $soal->kunci_jawaban;?></textarea></td>
                  </tr>
                  <tr>
