                              ...
                              if($jawaban != null AND $tempJawaban != -1){    
                                ...
                                ?>
                                  ...
                                  <?php if(trim(strtolower($s->e)) == trim(strtolower($s->kunci_jawaban))){
                                    ...
                                    <tr>
                                    <?php $ja = $s->e; ?>
                                      <td><label label style="font-size:12pt;"><b>A.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value='A. <?php echo strval($s->e);?>'
                                    ...
                                    <tr>
                                    <?php $ja = $s->a;?>
                                      <td><label label style="font-size:12pt;"><b>A.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value='A. <?php echo strval($s->a);?>'
                                    ...
                                    <tr>
                                    <?php $jb = $s->b;?>
                                      <td><label label style="font-size:12pt;"><b>B.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value='B. <?php echo strval($s->b);?>'
                                    ...
                                    <tr>
                                    <?php $jc = $s->c;?>
                                      <td><label label style="font-size:12pt;"><b>C.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value='C. <?php echo strval($s->c);?>'
                                    ...
                                    <tr>
                                    <?php $jd = $s->d;?>
                                      <td><label label style="font-size:12pt;"><b>D.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value='D. <?php echo strval($s->d);?>'
                                  ...
                                  <table>
                                    <?php if(trim(strtolower($s->e)) == trim(strtolower($s->kunci_jawaban))){
                                     ...
                                     <?php 
                                      ...
                                      <tr>
                                      <?php $ja = $s->d;?>
                                      <td><label label style="font-size:12pt;"><b>A.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value='A. <?php echo strval($s->d);?>'
                                      <?php if(trim($jawaban[$tempJawaban]->jawaban) == trim($s->d)){ echo "checked";}?>></td>
                                      <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->d;?></label></td>
                                      <td>
                                      <?php if(isset($s->gambarD)){ ?>
                                    ...
                                    <tr>
                                      <?php $jb = $s->a;?>
                                      <td><label label style="font-size:12pt;"><b>B.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value='B. <?php echo strval($s->a);?>'
                                      <?php if(trim($jawaban[$tempJawaban]->jawaban) == trim($s->a)){ echo "checked";}?>></td>                             
                                      <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->a;?></label></td>
                                      <td>
                                      <?php if(isset($s->gambarA)){ ?>
                                    ...
                                    <tr>
                                      <?php $jc = $s->b;?>
                                      <td><label label style="font-size:12pt;"><b>C.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value='C. <?php echo strval($s->b);?>'
                                      <?php if(trim($jawaban[$tempJawaban]->jawaban) == trim($s->b)){ echo "checked";}?>></td>
                                      <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->b;?></label></td>
                                      <td>
                                      <?php if(isset($s->gambarB)){ ?>
                                    ...
                                    <tr>
                                    <?php $jd = $s->c;?>
                                      <td><label label style="font-size:12pt;"><b>D.</b></label> &nbsp; <input type="radio" style="width: 1.5em; height: 1.5em;" name="answer" value='D. <?php echo strval($s->c);?>'
                                      <?php if(trim($jawaban[$tempJawaban]->jawaban) == trim($s->c)){ echo "checked";}?>></td>
                                      <td>&nbsp;<label style="font-size:12pt;"><?php echo $s->c;?></label></td>
                                      <td>
                                      <?php if(isset($s->gambarC)){ ?>
