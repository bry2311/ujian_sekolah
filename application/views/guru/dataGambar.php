        ...
        <div class="container-fluid">
          ...
          <div class="row">
              ...
              <div class="card-header py-3">
                ...
                <a class="btn btn-primary pull-right" style="margin:20px 20px 0px 20px" href="<?= base_url('guru/tambahGambar/');?>">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo $no;?></td>
                      <td><img class="pic" src='../assets/img/<?php echo $s->link;?>'> &nbsp;
                      <img class="picbig" src='../assets/img/<?php echo $s->link;?>'></td>
                      <td><?php echo $s->nama;?></td>
                      <td><?php echo $s->link;?></td>
                      <td> 
                          <a class="btn btn-danger btn-xs" href="<?= base_url('guru/hapusGambar/'.$s->id);?>" onclick="return confirm('Yakin akan menghapus data ini?');">
