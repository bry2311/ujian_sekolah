										...
										<tbody>
											...
											?>
												<tr>
													<td><?php echo $no; ?></td>
													<td>
														<a class="btn btn-primary btn-xs" href="<?= base_url('admin/aktifUjian/' . $u->id); ?>">
															<i class="fa fa-pencil">Aktif</i></a>
														<a class="btn btn-primary btn-xs" href="<?= base_url('admin/nonAktifUjian/' . $u->id); ?>">
															<i class="fa fa-pencil">Non-aktif</i></a>
													</td>
