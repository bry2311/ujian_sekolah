					...
					<div class="row">
						...
						<div class="card shadow mb-4" style="width:100%">
							...
							<div class="card-body">
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td><a class="btn btn-primary btn-xs" href="<?= base_url('admin/detailReport/' . $uj->id); ?>">
															<i class="fa fa-pencil">Naskah</i></a>
														<a class="btn btn-primary btn-xs" href="<?= base_url('admin/downloadNaskahAll/' . $uj->id); ?>">
															<i class="fa fa-pencil">All Naskah</i></a>
														<a class="btn btn-primary btn-xs" href="<?= base_url('admin/excelReport/' . $uj->id); ?>">
															<i class="fa fa-pencil">Rekap</i></a>
														<a class="btn btn-primary btn-xs" href="<?= base_url('admin/excelReport2/' . $uj->id); ?>">
															<i class="fa fa-pencil">Analisa</i></a>
														<a class="btn btn-primary btn-xs" href="<?= base_url('admin/excelReport3/' . $uj->id); ?>">
								...
								<a class="btn btn-primary btn-xs" href="<?= base_url('admin/cobaDownload'); ?>">
