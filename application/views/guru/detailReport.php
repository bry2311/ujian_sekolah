										...
										<tbody>
											...
											?>
												<tr>
													...
													<td><?php echo $n->tampil; ?></td>
													<td>
														<?php
														if ($jenis == "Isian" || $jenis == "Gabungan") {
														?>
															<a class="btn btn-warning btn-xs" href="<?= base_url('guru/nilaiUjian/' . $ujian->id . '/' . $n->nik); ?>">
																<i class="fa fa-pencil">Nilai ujian</i></a>
														<?php
														}
														?>
														<a class="btn btn-primary btn-xs" href="<?= base_url('guru/createPdf/' . $ujian->id . '/' . $n->nik . '/' . $n->kelas); ?>">
															<i class="fa fa-pencil">Download</i></a>
														<a class="btn btn-primary btn-xs" href="<?= base_url('guru/tampilNilai/' . $ujian->id . '/' . $n->id); ?>">
															<i class="fa fa-pencil">Tampil</i></a>
														<a class="btn btn-primary btn-xs" href="<?= base_url('guru/nonTampilNilai/' . $ujian->id . '/' . $n->id); ?>">
															<i class="fa fa-pencil">Sembunyi</i></a>
														<a class="btn btn-danger btn-xs" href="<?= base_url('guru/ujianUlang/' . $ujian->id . '/' . $n->id . '/' . $n->nik); ?>" onclick="return confirm('Apakah anda yakin akan menguji ulang siswa ini?');">
															<i class="fa fa-pencil">Ujian Ulang</i></a>
													</td>
												</tr>
											<?php
												$no++;
