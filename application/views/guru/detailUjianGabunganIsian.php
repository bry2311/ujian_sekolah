              ...
              <div class="card shadow mb-4" style="width:100%">
                <div class="card-header py-3">
                  <ul class="nav nav-second-level">
                    <li>
                      <a href="<?= base_url('guru/detailUjianGabungan/'.$ujian->id);?>">
                        <div class="card-header py-3">
                          <h6 class="m-0 font-weight-bold text-primary">Detail Ujian <?php echo"PG ( " . count($soal_ujian) ." )";?></h6>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="<?= base_url('guru/detailUjianGabunganIsian/'.$ujian->id);?>">
                        <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Detail Ujian <?php echo "Isian ( " . count($soal_ujian_isian) ." )";?></h6>
                        </div>
                      </a>
                    </li>
                  </ul> 
